function createMainFileERP1(pathToSave,K_str,CI,CI_str,dt)

f=fopen([pathToSave '/' K_str '/' CI_str '/data/main_file_ERP1.dat'],'w');
...
fprintf(f,'!------------------------------------------------------\n');
fprintf(f,['*RESTART, 0, FILE_R:"restartS1_' num2str(10000/dt) '_prc_"\n']);
fprintf(f,'!------------------------------------------------------\n');

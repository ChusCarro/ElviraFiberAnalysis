function plotCILimits(Model,K,K_dirFact)
...
for i=1:length(K)
    ...
    if(~isempty(dir([Model '/' K_str '/status.mat'])))
        ...
        if(isfield(sim_stat,'ERP1'))
            ...
            a=load([Model '/' K_str '/' CI_str '/post/ERP1_00000151.var']);
            b=load([Model '/' K_str '/' CI_str '/post/ERP1_00000176.var']);
            c=load([Model '/' K_str '/' CI_str '/post/ERP1_00000201.var']);
            d=load([Model '/' K_str '/' CI_str '/post/ERP1_00000226.var']);
            e=load([Model '/' K_str '/' CI_str '/post/ERP1_00000251.var']);
        ...
        if(isfield(sim_stat,'ERP2'))
            ...
            a=load([Model '/' K_str '/' CI_str '/post/ERP2_00000151.var']);
            b=load([Model '/' K_str '/' CI_str '/post/ERP2_00000176.var']);
            c=load([Model '/' K_str '/' CI_str '/post/ERP2_00000201.var']);
            d=load([Model '/' K_str '/' CI_str '/post/ERP2_00000226.var']);
            e=load([Model '/' K_str '/' CI_str '/post/ERP2_00000251.var']);
